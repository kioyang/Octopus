                ...
                <Form labelAlign="right" {...formLayout} ref={(el) => { this.form = el; }}>
                    ...
                    >
                        <Select>
                            ...
                            <Select.Option value="antProReact1">Ant Design Pro + Vue</Select.Option>
                        </Select>
                    </Form.Item>
                    <Form.Item initialValue={this.state.currentFolder} style={{ marginBottom: 0}} label="项目路径" name="projectDir">
                        <Input
                            addonAfter={<span
